...
#'
#' @export
#' @param x an object of the class summary.pope.
#' @param ... further arguments passed to or from other methods.
#' @return a summary of the fitted model.
print.summary.pope <- function(x, ...){
  if(x$approach=="mle"){
    cat("Call:\n")
    print(x$call)
    cat("\n")
    cat("Proportional odds coefficients:\n")
...
#'
#' @aliases summary.pope
#' @export
#' @param object an objecto of the class 'yppe'.
#' @param ... further arguments passed to or from other methods.
#'
summary.pope <- function(object, ...){
  p <- object$p
